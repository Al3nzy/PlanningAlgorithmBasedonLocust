...
public class CondorVM extends Vm {
	private double VmListFinishTimeProcessing; // alanzy 
    /*
    ...
    /**
	 * Gets the VmListFinishTimeProcessing.
	 * 
	 * @return VmListFinishTimeProcessing
	 */
	public double getVmListFinishTimeProcessing() {
		return VmListFinishTimeProcessing;
	}
	/**
	 * Set the VmListFinishTimeProcessing.
	 * 
	 * 
	 */
	public void setVmListFinishTimeProcessing(double vmListFinishTimeProcessing) {
		VmListFinishTimeProcessing = vmListFinishTimeProcessing;
	}

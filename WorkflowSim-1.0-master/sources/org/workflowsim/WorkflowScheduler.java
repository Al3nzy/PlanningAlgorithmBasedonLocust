...
import org.workflowsim.scheduling.LocustSchedulingAlgorithm;
import org.workflowsim.scheduling.Test2SchedulingAlgorithm;
import org.workflowsim.scheduling.test3SchedulingAlgorithm;
import org.workflowsim.scheduling.testmax;
    ...
    private BaseSchedulingAlgorithm getScheduler(SchedulingAlgorithm name) {
        ...
        switch (name) {
            ...
            case FCFS:
                ...
                break;
            case testmax:
                algorithm = new testmax();
                break;
            case test:
                algorithm = new test3SchedulingAlgorithm();
                break;
            case Locust:
                algorithm = new LocustSchedulingAlgorithm();
                break;
            case MINMIN:
